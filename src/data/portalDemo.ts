...
export const portalReleases: PortalRelease[] = [
  {
    ...
    assets: [
      { id: "ncict-mac", platform: "macOS", filename: "NCICT4.20260909_mac.dmg", size: "213 MB" },
      { id: "ncict-win", platform: "Windows", filename: "NCICT4.20260909_windows.exe", size: "205 MB" },
    ],
  },
  {
    id: "ncinm-3",
    ...
    assets: [
      { id: "ncinm-mac", platform: "macOS", filename: "NCINM3.20260909_mac.dmg", size: "397 MB" },
      { id: "ncinm-win", platform: "Windows", filename: "NCINM3.20260909_windows.exe", size: "268 MB" },
    ],
  },
  {
    id: "ncirf-4",
    ...
    assets: [
      { id: "ncirf-mac", platform: "macOS", filename: "NCIRF4.20260910_mac.dmg", size: "328 MB" },
      { id: "ncirf-win", platform: "Windows", filename: "NCIRF4.20260910_windows.exe", size: "310 MB" },
    ],
  },
  {
    id: "phantom-library",
  ...
  },
  {
    id: "dcc-library",
    tool: "DCC",
    name: "Dose conversion coefficients",
    version: "Current library",
