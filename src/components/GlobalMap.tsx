...
export const GlobalMap = () => {
  const locations = useMemo(() => [
    ...
    { name: "Spain", isoA3: "ESP", users: 10 },
    { name: "Iran", isoA3: "IRN", users: 10 },
    { name: "Turkey", isoA3: "TUR", users: 9 },
    { name: "Netherlands", isoA3: "NLD", users: 8 },
    { name: "South Korea", isoA3: "KOR", users: 8 },
    { name: "India", isoA3: "IND", users: 7 },
    { name: "Poland", isoA3: "POL", users: 7 },
    { name: "Sweden", isoA3: "SWE", users: 7 },
    { name: "Denmark", isoA3: "DNK", users: 6 },
    { name: "Oman", isoA3: "OMN", users: 6 },
    { name: "Switzerland", isoA3: "CHE", users: 6 },
    { name: "Finland", isoA3: "FIN", users: 5 },
    { name: "Indonesia", isoA3: "IDN", users: 5 },
    { name: "Philippines", isoA3: "PHL", users: 5 },
    { name: "Saudi Arabia", isoA3: "SAU", users: 5 },
    { name: "Czechia", isoA3: "CZE", users: 4 },
    { name: "Bulgaria", isoA3: "BGR", users: 4 },
    { name: "Greece", isoA3: "GRC", users: 4 },
    { name: "Morocco", isoA3: "MAR", users: 4 },
    { name: "Thailand", isoA3: "THA", users: 4 },
    ...
    { name: "Ethiopia", isoA3: "ETH", users: 2 },
    { name: "Ghana", isoA3: "GHA", users: 2 },
    { name: "Luxembourg", isoA3: "LUX", users: 2 },
    { name: "Malaysia", isoA3: "MYS", users: 2 },
    { name: "Nigeria", isoA3: "NGA", users: 2 },
    { name: "Romania", isoA3: "ROU", users: 2 },
    { name: "South Africa", isoA3: "ZAF", users: 2 },
    { name: "Taiwan", isoA3: "TWN", users: 2 },
    { name: "Ukraine", isoA3: "UKR", users: 2 },
    { name: "United Arab Emirates", isoA3: "ARE", users: 2 },
    { name: "Argentina", isoA3: "ARG", users: 1 },
    { name: "Belarus", isoA3: "BLR", users: 1 },
    { name: "Chile", isoA3: "CHL", users: 1 },
    { name: "Iraq", isoA3: "IRQ", users: 1 },
    { name: "Kazakhstan", isoA3: "KAZ", users: 1 },
    { name: "Kuwait", isoA3: "KWT", users: 1 },
    { name: "New Zealand", isoA3: "NZL", users: 1 },
    { name: "Palestine", isoA3: "PSE", users: 1 },
    { name: "Qatar", isoA3: "QAT", users: 1 },
    { name: "Senegal", isoA3: "SEN", users: 1 },
