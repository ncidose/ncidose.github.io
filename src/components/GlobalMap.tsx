...
export const GlobalMap = () => {
  const locations = useMemo(
    () => worldMapData.locations.filter((location) => !excludedCountryIsoA3.has(location.isoA3)),
    [],
  );
  ...
  const mapUpdatedAt = worldMapData.updatedAt;
  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-6">
        ...
        >
          Map shows the approximate geographic distribution represented in NCI Dose Tools
          Software Transfer Agreement records. Pending, executed, withdrawn, and closed records
          are included. Counts are inferred from institutional information and do not represent
          commercial use or clinical deployment.
        </motion.p>
