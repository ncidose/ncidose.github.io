              ...
              <div className="border border-sky-100 bg-white/90 p-6 shadow-lg shadow-sky-900/5 backdrop-blur-sm">
                ...
                <dl className="mt-5 space-y-4 text-sm">
                  <div className="flex items-center justify-between gap-4 border-b border-slate-100 pb-4">
                    <dt className="flex items-center gap-2 text-slate-500"><Clock3 className="h-4 w-4 text-primary" /> Latest release</dt>
                    <dd className="text-right text-slate-900">{history.latestRelease}</dd>
                  </div>
                  <div className="flex items-center justify-between gap-4 border-b border-slate-100 pb-4">
                    <dt className="flex items-center gap-2 text-slate-500"><CheckCircle2 className="h-4 w-4 text-primary" /> Scientific update</dt>
                    <dd className="text-right text-slate-900">{history.latestScientificUpdate}</dd>
                  </div>
