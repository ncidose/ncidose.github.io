...
CREATE TABLE IF NOT EXISTS users (
  ...
  discussion_role TEXT NOT NULL DEFAULT 'community' CHECK (discussion_role IN ('community', 'team')),
  discussion_handle TEXT,
...
CREATE TABLE IF NOT EXISTS qa_questions (
  ...
  author_name TEXT,
  author_type TEXT NOT NULL DEFAULT 'community' CHECK (author_type IN ('community', 'team')),
...
CREATE INDEX IF NOT EXISTS idx_user_identities_user_primary ON user_identities(user_id, is_primary DESC, created_at ASC);
